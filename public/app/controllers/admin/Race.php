...
//            die();
      ...
      if ($id) {
        ...
        if ($action == "add") {
          $edition_id = $this->race_model->get_edition_id($id);
          $this->return_url = base_url("admin/edition/create/edit/" . $edition_id. "#races");
          $alert="Race was successfully added to the edition";
        }
      } else {
