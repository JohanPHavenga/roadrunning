<?php
//$img_url = "https://dev.virtualearth.net/REST/V1/Imagery/Map/Road/" . $edition_data['edition_gps'] . "/11?mapSize=300,1224&format=png&key=An56kGemZ2QHt-SqwYx3fi9E89M_lMQDqODLp55fEnUejV10d2fH9jkrlUoC6xlS";
...
//$img_url = "https://maps.googleapis.com/maps/api/staticmap?center=". urlencode($edition_data['edition_address']) . "," . urlencode($edition_data['town_name']) ."&zoom=13&size=1920x160&maptype=roadmap&key=AIzaSyBERO5xjCtTOmjQ_zSSUvlp5YN_l-4yKQw";
