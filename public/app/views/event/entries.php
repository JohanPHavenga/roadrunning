        ...
        <div class="row">
            ...
            <div class="content col-lg-9">
                <div class="single-post">
                    ...
                    <div class="row m-b-40 post-item">
                            ...
                            if (in_array(5, $edition_data['entrytype_list'])) {
                                ...
                                <ul>
                                    ...
                                    if (isset($edition_data['entrytype_list'][4])) {
                                        if ($url_list[5]) {
                                            echo "<li><a href='" . $url_list[5][0]['url_name'] . "' class='link'>Enter Online</a></li>";
            ...
            <div class="sidebar col-lg-3">                
                <!--widget newsletter-->
                <div class="widget clearfix widget-image">
                    <div class="carousel dots-inside dots-dark arrows-visible arrows-only arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="none" data-animate-out="none" data-autoplay-timeout="2500" data-lightbox="gallery">
                ...
                <!--widget tags-->
                <div class="widget clearfix widget-race-buttons">
                    <h3>
                        <?php
                        foreach ($edition_data['race_summary']['list'] as $race) {
                            echo '<span class="badge badge-' . $race['color'] . '"><a href="">' . floatval($race['distance']) . '<small>km</small><br><small>' . $race['type'] . '</small></a></span> ';
                        }
                        ?>
                    </h3>
                </div>
